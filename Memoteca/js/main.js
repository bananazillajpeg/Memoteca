...
async function manipularSubmissaoFormulario(event) {
  ...
  if (!validarConteudo(conteudoSemEspacos)) {
    alert("É permitido a inclusão apenas de letras e espaços e o minimo de 10 caracteres")
    return
  }
  if (!validarAutoria(autoriaSemEspacos)) {
    alert("A autoria não pode conter espaços e exige entre três a quinze caracteres")
    return
  }
